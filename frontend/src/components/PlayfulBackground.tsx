    ...
    <div className="fixed inset-0 -z-10 overflow-hidden bg-white">
      ...
      <div className="absolute top-1/4 right-1/4 opacity-[0.08] animate-float-slow">
        <svg width="120" height="140" viewBox="0 0 120 140" fill="none">
          <rect x="10" y="0" width="100" height="130" rx="8" fill="currentColor" className="text-blue-400"/>
          <line x1="25" y1="25" x2="95" y2="25" stroke="white" strokeWidth="3"/>
          <line x1="25" y1="45" x2="95" y2="45" stroke="white" strokeWidth="3"/>
          <line x1="25" y1="65" x2="75" y2="65" stroke="white" strokeWidth="3"/>
      ...
      <div className="absolute bottom-1/3 left-1/4 opacity-[0.08] animate-float animation-delay-2000">
        <svg width="100" height="120" viewBox="0 0 100 120" fill="none">
          <rect x="5" y="0" width="90" height="110" rx="6" fill="currentColor" className="text-indigo-400"/>
          <line x1="20" y1="20" x2="80" y2="20" stroke="white" strokeWidth="2.5"/>
          <line x1="20" y1="35" x2="80" y2="35" stroke="white" strokeWidth="2.5"/>
          <line x1="20" y1="50" x2="80" y2="50" stroke="white" strokeWidth="2.5"/>
          <line x1="20" y1="65" x2="60" y2="65" stroke="white" strokeWidth="2.5"/>
        </svg>
      </div>
      ...
      <div className="absolute top-1/3 left-1/5 opacity-[0.12] animate-float animation-delay-1000">
        <svg width="60" height="60" viewBox="0 0 24 24" fill="none" className="text-green-500">
      ...
      {/* Decorative lines */}
      <svg className="absolute top-1/2 left-0 w-full h-full opacity-[0.04]" preserveAspectRatio="none">
        <line x1="0%" y1="30%" x2="100%" y2="35%" stroke="currentColor" strokeWidth="1" className="text-blue-300"/>
        <line x1="0%" y1="60%" x2="100%" y2="58%" stroke="currentColor" strokeWidth="1" className="text-indigo-300"/>
      </svg>
