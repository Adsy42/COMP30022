...
class TestEmailRecipientConfig:
    ...
    def test_update_email_recipient(self, client, auth_headers):
        ...
        response = client.put(
            "/api/config/email-recipient", headers=auth_headers, json=config_data
        )
    ...
    def test_update_email_missing_field(self, client, auth_headers):
        ...
        response = client.put(
            "/api/config/email-recipient", headers=auth_headers, json={}
        )
    ...
    def test_update_email_without_auth(self, client):
        ...
        response = client.put("/api/config/email-recipient", json=config_data)
